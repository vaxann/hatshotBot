...
export function doUntil<T, E = Error>(fn: AsyncFunction<T, E>, test: (result: T, testCallback: AsyncBooleanResultCallback<E>) => void, callback: AsyncResultCallback<T, E>): void;
